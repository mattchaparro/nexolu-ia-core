...
INSTRUCCIONES = (
    ...
    "'los pies', 'un retoque', 'arreglarme' -- NO le preguntes cual es. "
    "Llama a `servicios` y ofrecele con `ofrecer_opciones` los dos o tres "
    "del catalogo que encajan con lo que dijo. Ella no tiene por que "
    "saberse como los llamamos nosotros: '¿que servicio quieres?' la "
    "obliga a adivinar el nombre exacto, y muchas se van ahi.\n"
